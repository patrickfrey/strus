...
if( APPLE )
file( GLOB_RECURSE fl "libleveldb.dylib" RELATIVE  "${LEVELDB_ROOT}" )
else( APPLE )
file( GLOB_RECURSE fl "libleveldb.so" RELATIVE  "${LEVELDB_ROOT}" )
endif( APPLE )
if ( fl )
list( GET fl 0 fl0 )
get_filename_component( NAME fl0 LevelDB_LIBRARY )
get_filename_component( PARENT_DIR fl0 fdir )
get_filename_component( PARENT_DIR fdir LevelDB_LIBRARY_PATH )
endif ( fl )
