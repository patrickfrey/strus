...
StructView ScalarFunctionParser::view() const
{
	return StructView()
		("name", "scalar")
		("description", "parser for arithmetic expressions on double precision floating point values with operators *,-,*,/ and unary and binary functions as defined in the C math library. External arguments are adressed with decimal numbers with a preceding '_', e.g. _0 for the first argument")
	;
}
